...
# Steps to build:
 ...
 1. Before next step make sure that you installed all required components mentioned on the [Development Environment Setup](https://github.com/trustedanalytics/platform-wiki-latest/wiki/Development-Environment-Setup) page.
